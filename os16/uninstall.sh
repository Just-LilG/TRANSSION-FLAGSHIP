...
log_msg "=== TransFlagship 16 V1.39 uninstall start ==="
...
settings delete system tran_need_recovery_refresh_rate 2>/dev/null
...
log_msg "=== TransFlagship 16 V1.39 uninstall complete — reboot ==="
