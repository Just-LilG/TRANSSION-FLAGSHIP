...
log_p "  game_gt=$(getprop ro.os_game_gt.support 2>/dev/null)"
log_p "  esports10=$(getprop ro.os_game_tp_esports10.support 2>/dev/null)"
log_p "  esports30=$(getprop ro.os_game_tp_esports30.support 2>/dev/null)"
log_p "  bypass=$(getprop ro.os_game_bypass_charging_support 2>/dev/null)"
