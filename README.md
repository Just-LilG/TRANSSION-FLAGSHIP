...
Flagship 16 has its own WebUI. Features are added **one at a time** after they are verified on a real OS 16 device. **V1.07 is boot animation + boot sound** (XOS / HiOS 16 / Custom / Off animation; Waltz / Custom / Off sound via Unisoc `bootsound.mp3` next to the zip). Installer disables Flagship 15 if it is still active.
