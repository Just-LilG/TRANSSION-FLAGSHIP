...
Flagship 16 has its own WebUI. Features are added **one at a time** after they are verified on a real OS 16 device. **V1.05 is boot animation + boot sound** (XOS / HiOS 16 / Custom / Off animation; Waltz / Custom / Off sound via tinyplay — zip audio is silent on XOS 16). Installer disables Flagship 15 if it is still active.
